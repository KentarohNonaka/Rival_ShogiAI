'''
uct_node.py
This file is a redistribution of uct_node.py from python-dlshogi2 by Tadao Yamaoka.
The original code can be found at <https://github.com/TadaoYamaoka/python-dlshogi2/blob/main/pydlshogi2/uct/uct_node.py>
